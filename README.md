...
# Client
Create a new tampermonkey script for gats.io and paste in [`userscript.js`](./src/Client/scripts/userscript.js) and save it. Make sure the port matches your server port and your server is running before reloading the site.
...
# Gamemodes
gats-custom currently supports the following gamemodes:
```
- FFA
- CTF
```
